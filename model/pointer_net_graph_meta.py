...
default_var_dict = {
  ...
  "train_inputs_2": "graph/train_inputs_2:0",
  "train_outputs_2": "graph/train_outputs_2:0",
  "train_input_mask_2": "graph/train_input_mask_2:0",
  "train_output_mask_2": "graph/train_output_mask_2:0",
  "seq2seq_feed_previous_2": "graph/seq2seq_feed_previous_2:0",
  ...
  "input_switch": "graph/input_switch:0",
  "type_masks": "graph/type_masks:0",
  "type_masks_2": "graph/type_masks_2:0"
}


def construct_weights(pretrained_enc_embedding, input_vocab, output_vocab, embedding_size, n_hidden):
  weights = {}
...
def forward(inp, weights, decoder_type, explicit_pointer, value_based_loss,
...
def build_graph(decoder_type, explicit_pointer, value_based_loss,
  ...
  with graph.as_default(), tf.variable_scope(scope or "graph") as scope:
    ...
    total_loss, _, _, _ =\
      forward(inp, weights, decoder_type, explicit_pointer, value_based_loss,
